...
SECRET_KEY = 'django-insecure-k9!xx7m*%c69rtoeh1+lmp%ep+*gw89d9ci24dm3f0nrst4a-z'
...
MIDDLEWARE = [
    ...
    'chat_application.middleware.RequestLoggerMiddleware'
]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'web.log',  # Replace with the path to your log file
        },
    },
    'loggers': {
        'django.channels': {
